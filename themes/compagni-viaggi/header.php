    ...
    <div class="container">
        ...
        <div class="header-actions desktop-only">
            <?php if (is_user_logged_in()) : ?>
                ...
                <a href="<?php echo esc_url(home_url('/crea-attività')); ?>" class="btn-header btn-header-primary">
                    Crea Annuncio
                </a>
...
function cdv_fallback_menu() {
    ...
    echo '<li><a href="' . esc_url(home_url('/attività')) . '">Attività</a></li>';
...
function cdv_fallback_mobile_menu() {
    ...
    if (is_user_logged_in()) {
        echo '<li><a href="' . esc_url(home_url('/dashboard')) . '">👤 Dashboard</a></li>';
        echo '<li><a href="' . esc_url(home_url('/crea-attività')) . '">➕ Crea Annuncio</a></li>';
