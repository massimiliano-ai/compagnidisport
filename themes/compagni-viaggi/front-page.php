                ...
                <div class="search-box">
                    <form class="search-form" action="<?php echo esc_url(home_url('/')); ?>" method="get">
                        ...
                        <div class="form-group">
                            ...
                            <select id="activity_type" name="tipo_sport">
                    ...
                    <div class="hero-cta" style="text-align: center; margin-top: calc(var(--spacing-unit) * 4);">
                        <a href="<?php echo esc_url(get_theme_mod('cdv_hero_button_url', '/crea-attività')); ?>" class="btn-primary btn-large" style="font-size: 1.1rem; padding: calc(var(--spacing-unit) * 2) calc(var(--spacing-unit) * 4); display: inline-flex; align-items: center; gap: calc(var(--spacing-unit) * 1); box-shadow: 0 4px 20px rgba(0,0,0,0.2);">
        ...
        <div class="container">
            ...
            <div class="grid">
                <div class="step-card">
                    ...
                    <p><?php echo esc_html(get_theme_mod('cdv_step1_text', 'Registrati e completa il tuo profilo con interessi, lingue parlate e stili di attività preferiti.')); ?></p>
                </div>
                ...
                <div class="step-card">
                    ...
                    <p><?php echo esc_html(get_theme_mod('cdv_step3_text', 'Usa la chat di gruppo per conoscere i compagni di sport e organizzare i dettagli insieme.')); ?></p>
                </div>
            </div>
            ...
            <div class="stories-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(350px, 1fr)); gap: calc(var(--spacing-unit) * 4);">
                ...
                if ($recent_stories->have_posts()) :
                    ...
                    <div class="no-stories" style="grid-column: 1 / -1; text-align: center; padding: calc(var(--spacing-unit) * 4) 0;">
                        <p style="color: var(--text-medium);">Nessun storia sport disponibile al momento.</p>
                    </div>
                    <?php
                endif;
                ?>
            ...
            <?php if ($recent_stories->found_posts > 0) : ?>
                <div class="text-center mt-3">
                    <a href="<?php echo esc_url(home_url('/storie sport')); ?>" class="btn-primary">
                        <?php echo esc_html(get_theme_mod('cdv_stories_button_text', 'Vedi Tutti i Storie Sport')); ?> →
                    </a>
                </div>
            <?php endif; ?>
        </div>
    ...
    <section class="section cta-section" style="background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); color: white;">
        <div class="container text-center">
            ...
            <?php if (is_user_logged_in()) : ?>
                <a href="<?php echo esc_url(home_url('/crea-attività')); ?>" class="btn-primary">
